"""
Pydantic schemas for ChatMessage and ChatHistorySnapshot models.
"""
...
class ChatHistorySnapshotBase(BaseModel):
    """Base schema for ChatHistorySnapshot."""
...
class ChatHistorySnapshotResponse(ChatHistorySnapshotBase):
    """Schema for chat history snapshot responses."""
